    ...
    <div className={`bg-white rounded-lg border border-gray-200 p-6 sticky top-8 ${className}`}>
        ...
        {!promoApplied ? (
          <div className="flex gap-2">
            <input
              ...
              className="flex-1 px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#fe004d] focus:border-[#fe004d] text-sm"
      ...
      <div className="space-y-4 mb-6">
        ...
        <div className="border-t border-gray-200 pt-4">
          <div className="flex justify-between text-xl font-bold text-gray-900">
            <span>Total:</span>
            <span className="text-[#fe004d]">{formatPrice(totalAmount)}</span>
          </div>
        </div>
      </div>
      ...
      <div className="space-y-3">
        <button
          ...
          className="w-full bg-[#fe004d] text-white py-4 px-6 rounded-lg font-semibold text-lg hover:bg-[#e6003d] disabled:bg-gray-300 disabled:cursor-not-allowed transition-colors flex items-center justify-center gap-2"
        >
