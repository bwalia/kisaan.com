...
const HeroSection: React.FC<HeroSectionProps> = ({ onSearch, searchLoading = false }) => {
  ...
  return (
    <div className="relative bg-gradient-to-br from-[#fe004d] to-[#e6003d] text-white overflow-hidden">
      ...
      <div className="relative container mx-auto px-6 py-16 lg:py-24">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <Link
              href="/register"
              className="bg-white text-[#fe004d] px-8 py-4 rounded-full font-semibold text-lg hover:bg-gray-100 transition-colors duration-200 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5"
            >
              Start Selling Today
            </Link>
            <button
              onClick={scrollToProducts}
              className="border-2 border-white text-white px-8 py-4 rounded-full font-semibold text-lg hover:bg-white hover:text-[#fe004d] transition-all duration-200"
            >
              Browse Products
            </button>
          </div>
