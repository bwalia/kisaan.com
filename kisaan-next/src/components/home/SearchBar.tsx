      ...
      <form onSubmit={handleSubmit} className="relative">
        <div className="relative">
          ...
          <input
            ...
            className="w-full pl-12 pr-20 py-4 text-lg border-2 border-gray-200 rounded-full focus:border-[#fe004d] focus:outline-none focus:ring-0 transition-colors duration-200"
            disabled={loading}
          />
          ...
          <button
            type="submit"
            disabled={loading}
            className="absolute inset-y-0 right-2 flex items-center justify-center w-12 h-[calc(100%-16px)] my-2 bg-[#fe004d] text-white rounded-full hover:bg-[#e6003d] transition-colors duration-200 disabled:opacity-50"
          >
            {loading ? (
