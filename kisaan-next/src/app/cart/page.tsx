        ...
        <div className="bg-white rounded-lg border border-gray-200 p-8 text-center max-w-md mx-4">
          ...
          <div className="space-y-3">
            <button
              ...
              className="w-full bg-[#fe004d] text-white py-3 px-6 rounded-lg font-semibold hover:bg-[#e6003d] transition-colors"
            >
              Login to Continue
            </button>
            <button
    ...
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="container mx-auto px-6">
        ...
        <nav className="flex items-center space-x-2 text-sm mb-8">
          <Link
            href="/"
            className="text-gray-500 hover:text-[#fe004d] transition-colors"
          >
            Home
          </Link>
          <svg
