...
SECRET_INPUT_PATH="kisaan.com-devops/kubeseal/secret_kisaan_per_env_input_template.yaml"
SECRET_OUTPUT_PATH="kisaan.com-devops/kubeseal/secret_kisaan_${ENV_REF}.yaml"
...
# rm -Rf $SECRET_OUTPUT_PATH
# cat sealed_secret_kisaan_prod.yaml
...
rm -Rf temp.txt
rm -Rf sealed_secret_kisaan_${ENV_REF}.txt
