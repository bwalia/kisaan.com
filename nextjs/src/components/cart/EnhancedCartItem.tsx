      ...
      <div className="flex gap-6">
        ...
        <div className="flex-1 min-w-0">
          <div className="flex justify-between items-start">
            <div className="flex-1 min-w-0">
              <Link href={`/products/${item.product_uuid}`}>
                <h3 className="font-semibold text-lg text-gray-900 hover:text-[#16a34a] transition-colors line-clamp-2">
                  {item.name}
                </h3>
              </Link>
            ...
            <div className="flex items-center gap-3">
              ...
              {isUpdating && (
                <div className="flex items-center text-sm text-gray-600">
                  <div className="animate-spin rounded-full h-4 w-4 border-b-2 border-[#16a34a] mr-2"></div>
                  Updating...
                </div>
              )}
            </div>
